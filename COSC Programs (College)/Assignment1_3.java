...
/*
 * Description: Write a second version of the previous program and read numbers from an input file. Get the file name from the user, 
 * handle the FileNotFoundException exception (try/catch) and consume unwanted input.
 */ 
...
public class Assignment1_3 {
	...
	//Checks to see if there are ints within the file; returns count of ints
	...
	public static void main(String[] args) {
		//Declarations and Instatiations
		...
		if(fileOpened) //Executes if file was found
		{
			...
			if(size > 0) {
				...
				while(option != 0) {
					...
					switch(option){ // Calls to the method corresponding to the menu
						...
						case 6: 
							...
							list = shiftRightK(list, list.length, a);
				...
				System.out.println("Testing Completed. Exit Program. ");	
			}
